...
<head>
  ...
  <link rel="stylesheet" href="../../public/css/Parrillas.css">
</head>
<body>
...
<?php require_once '../partials/header.php'; ?>
  ...
  <section class="hero d-flex flex-column justify-content-center align-items-center">
    <h1><b>🔥🥩🍷 Sabor a la Parrilla 🍷🥩🔥</b></h1>
  </section>

  <section id="menu" class="container py-5 menu-section">
  <h2 class="text-center mb-4">Parrilla</h2>
...
fetch("http://localhost/RutaDelSaborChincha123/controllers/Restaurantes.php?task=listarPorCategoria&idcategoria=9")
