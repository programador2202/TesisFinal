...
<?php require_once '../partials/header.php'; ?>
  ...
  <section class="hero d-flex flex-column justify-content-center align-items-center">
    <h1><b>🔥🥂🐓 De Brasa en Brasa 🐓🥂🔥</b></h1>
  </section>

  <section id="menu" class="container py-5 menu-section">
  <h2 class="text-center mb-4">Pollerias</h2>
...
document.addEventListener("DOMContentLoaded", () => {
  fetch("http://localhost/RutaDelSaborChincha123/controllers/Restaurantes.php?task=ListaPollerias")
    ...
    .then(data => {
     ...
     class="card-img-top" alt="${rest.nom_restaurante}">
        ...
        container.innerHTML = `<p class="text-center text-muted">No hay Pollerias disponibles.</p>`;
      }
    })
    .catch(error => {
