...
<body>
  ...
  <script>
    async function cargarDatos() {
      ...
      const rData = restaurantes.map(r => platos.filter(p => p.idrestaurante == r.idrestaurante).length);
      ...
      const cData = categorias.map(c => platos.filter(p => p.idcategoria == c.idcategoria).length);
