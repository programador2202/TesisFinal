...
<section class="marino-header d-flex flex-column align-items-center justify-content-center text-center py-4">
  <!---<img src="../../public/img/Marca-de-daito.png" 
      ...
      <h1 class="text-white">🐟🍤 DAITO ORIENTAL! 🐟🍤</h1>
</section>
  ...
  <!-- PLATOS DESTACADOS -->
    <section class="container py-5" id="platosDestacados">
        <h1 class="text-black fw-bold mt-2 text-center" style="z-index:2;">Restaurante El DAITO Oriental</h1>
...
<script>
  ...
  async function cargarPlatos() {
    try {
      const response = await fetch('../../controllers/Platos.php?task=ListarPlatos&idrestaurante=5');
